/*
* Creo la interfaz pokemon copiando la respuesta del API de 'https://pokeapi.co/api/v2/pokemon/1' del navegador como base
* tome los datos de la respuesta de axios ubicados en 'data'
? respuesta detallada al final del documento
*/
...
/*
* data que retorna axios
* SE PUEDE USAR LA WEB quicktype.io para obtener los tipos
